...
1.[Розділ 1. Філософія та базові концепції ООП в Python](#розділ-1-філософія-та-базові-концепції-ооп-в-python)

- [1.1 "Все є об'єктом": Фундаментальний принцип Python](#11-все-є-обєктом-фундаментальний-принцип-python)

- [1.2 Дизайн ООП: Паскаль vs Перл](#12-дизайн-ооп-паскаль-vs-перл)
